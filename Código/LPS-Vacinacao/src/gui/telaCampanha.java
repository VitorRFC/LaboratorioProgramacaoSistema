...
import lps.vacinacao.CampanhaVacina;
...
public class telaCampanha extends javax.swing.JFrame {
    ...
    private ArrayList<CampanhaVacina> arrayCampanha = new ArrayList();
    ...
    public void excluiCampanha() throws ParseException{
        try {
            int lote;
    ...
    public CampanhaVacina buscarCampanha (int lote){
        for (int i =0; i<arrayCampanha.size(); i++){
           if(arrayCampanha.get(i).getLote()== lote){
               return arrayCampanha.get(i);
           } 
        }
        return null;
    }
    ...
    public void carregarCampanha() throws ParseException{
        ...
        try {
            ...
            while(resultado.next()){
                ...
                arrayCampanha.add(campanhaVacina);
